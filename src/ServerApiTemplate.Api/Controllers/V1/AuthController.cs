using ServerApiTemplate.Application.Features.V1.Auth.Commands.ForgotPassword;
using ServerApiTemplate.Application.Features.V1.Auth.Commands.Login;
using ServerApiTemplate.Application.Features.V1.Auth.Commands.Logout;
using ServerApiTemplate.Application.Features.V1.Auth.Commands.RefreshToken;
using ServerApiTemplate.Application.Features.V1.Auth.Commands.Register;
using ServerApiTemplate.Application.Features.V1.Auth.Commands.ResetPassword;
using ServerApiTemplate.Application.Features.V1.Auth.DTOs;
using ServerApiTemplate.Application.Features.V1.Auth.Queries.GetCurrentUser;
using MediatR;

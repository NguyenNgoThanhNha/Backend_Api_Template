...
namespace ServerApiTemplate.Application.Features.V1.Auth.Services;
...
public sealed class AuthTokenIssuer(IJwtTokenService jwt, IUnitOfWork<ServerApiTemplateDbContext> unitOfWork, TimeProvider clock)
    : IAuthTokenIssuer
{

...
using ServerApiTemplate.Application.Features.V1.Roles.Queries;
using ServerApiTemplate.Application.Features.V1.Roles.Services;
using ServerApiTemplate.Domain.Entities.Sys;

namespace ServerApiTemplate.Application.Features.V1.Roles.Commands;
...
{
    public SaveRoleCommandValidator(IUnitOfWork<ServerApiTemplateDbContext> unitOfWork)
    {
...
public sealed class SaveRoleCommandHandler(IUnitOfWork<ServerApiTemplateDbContext> unitOfWork, IPermissionService permissionService)
...
public sealed class DeleteRoleCommandHandler(IUnitOfWork<ServerApiTemplateDbContext> unitOfWork, IPermissionService permissionService)

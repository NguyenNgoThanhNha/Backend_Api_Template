namespace ServerApiTemplate.Application.Features.V1.ApiLogs.DTOs
{
...
namespace ServerApiTemplate.Application.Features.V1.ApiLogs.Queries
{
    ...
    public sealed class SearchApiLogsQueryHandler(IUnitOfWork<ServerApiTemplateDbContext> unitOfWork)
    ...
    public sealed class GetApiLogDetailQueryHandler(IUnitOfWork<ServerApiTemplateDbContext> unitOfWork)

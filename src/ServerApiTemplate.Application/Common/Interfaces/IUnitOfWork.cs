...
namespace ServerApiTemplate.Application.Common.Interfaces;

/// <summary>
/// Cửa truy cập dữ liệu DUY NHẤT cho handler (chuẩn BE §5). Handler inject IUnitOfWork&lt;ServerApiTemplateDbContext&gt;,

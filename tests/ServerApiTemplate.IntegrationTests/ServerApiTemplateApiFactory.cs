...
/// </summary>
public sealed class ServerApiTemplateApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        else
        {
            ...
            _connectionString = new SqlConnectionStringBuilder(_container.GetConnectionString()) { InitialCatalog = "ServerApiTemplateTest" }.ConnectionString;
        }
    ...
    public new async Task DisposeAsync()
    {
        if (_container is null)
        {
            ...
            await scope.ServiceProvider.GetRequiredService<ServerApiTemplateDbContext>().Database.EnsureDeletedAsync();
        }
...
public sealed class ApiCollection : ICollectionFixture<ServerApiTemplateApiFactory>
{
